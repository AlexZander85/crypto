...
# 🚀 КриптоНавигатор SaaS (feat/saas-v12)

Онлайн-версия курса как платный сервис на бесплатном стеке Cloudflare — ветка `feat/saas-v12`, полная документация в [`saas/README.md`](saas/README.md), деплой — [`DEPLOY_GUIDE_CLOUDFLARE.md`](DEPLOY_GUIDE_CLOUDFLARE.md) (часть 2).

- **213 уроков v12.9** в пошаговом режиме «🎓 Обучение», демо-витрина Фаза 0 + П1–П8 бесплатно;
- **облачный прогресс** (116 ключей cn_*, синк по политикам map-merge/max-wins/LWW), вход без пароля (magic-link + OAuth);
- **тарифы** Демо / Лайт 990₽ / Про 1990₽ / Макс 399₽/мес — контент-паки выдаёт воркер после проверки тарифа, статикой платное не отдаётся;
- **🌍 живой рынок** (6 источников, кэш 45с) и **🤖 AI-наставник** (Workers AI, лимиты по тарифам, серверный фильтр фин-советов) + доказательный RAG по 302 атомам 15 книг;
- **PWA**: установка на домашний экран, офлайн-режим на скачанных паках;
- **админка** `/admin`: воронка, AI-расход, пользователи, контент, audit-лог, GDPR.

Быстрый старт и приёмка — `saas/README.md`.
