...
| Метрика | Значение |
|---|---|
| 📚 **Всего уроков** | **158** (60 основных + 22 бонусных + 44 математики + **32 психологии и риск-инженерии**) |
| 🗺️ **Фаз обучения** | **9** (Фазы 0–6 + Фаза М (Математика) + **Фаза П (Психология)**) |
| 🧩 **Интерактивных виджетов и симуляторов** | **169** встроенных в уроки (включая Монте-Карло, стакан, ликвидации, дельта-нейтрал) |
| 🧠 **Психологических тренажёров** | **32** интерактивных тренажёра (по одному на каждый урок П1–П32) |
| ❓ **Банк ситуационных тестов самопроверки** | **96** гарвардских бизнес-кейсов (по 3 на каждый урок П1–П32) |
...
```mermaid
flowchart LR
    A["🟣 Ф0<br/>Фундамент (20)"] --> B["🔵 Ф1–4<br/>Ядро алго-трейдинга (33)"] --> C["🧠 Фаза П<br/>Академия психологии (32)"] --> D["🟢 Ф5<br/>Система и капитал (7)"] --> E["🏦 Финальный Экзамен"]
...
## 🧠 Фаза П — Академия психологии и риск-инженерии (32 урока, П1–П32)

Главный риск любой системы — её владелец. Этот блок объединяет идеи и методики из **14 фундаментальных мировых бестселлеров** по психологии трейдинга, нейроэкономике и науке о рисках (*Jared Tendler, Tom Hougaard, Mark Douglas, Mark Minervini, Brett Steenbarger, Nassim Taleb, David Spiegelhalter, Morgan Housel, Daniel Crosby, Gary Edward, Jason Zweig, Jack Schwager, Brett Goldstein, Александр Могилат*).

Блок состоит из **6 специализированных модулей**, **32 интерактивных тренажеров** и **96 ситуационных задач самопроверки**:
...
6. `🧘 Психология и риск-контроль (96 кейсов)` — решение глубоких психологических кейсов по всем 32 урокам Фазы П.
