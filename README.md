...
Проект прошёл 5 итераций внешнего аудита (V1 → V5). Полный реестр изменений с техническими якорями и контрольными точками — в [`CHANGELOG_VANILLA_TO_V5.md`](./CHANGELOG_VANILLA_TO_V5.md).
