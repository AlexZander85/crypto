...
|---|---|---|---|
| `core_demo` | всем | Фаза 0 (20 уроков) + Психология П1–П8 | 36KB |
| `core_p0…p8` | paid | 134 урока по фазам (бюджет §21.1 ≤150KB brotli — макс 36KB) | 10–33KB |
| `terms` | paid | глоссарий, 205 терминов | 24KB |
| `tests` | paid | 6 фазовых аттестаций + 2 математических теста | 22KB |
| `earning` | paid | 20 способов заработка | 10KB |

134 урока = LESSONS(76) + MATH(44) + PSY(8) + Вайбкодинг(4) + БОН(2) — сходится с фактом продукта.
Скрипт проверяет целостность (205 терминов, П1–П8, квизы у всех 134 уроков) и brotli-бюджет каждого пака — сборка падает при нарушении.
