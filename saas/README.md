...
|---|---|---|---|
| `core_demo` | всем | Фаза 0 (20 уроков) + Психология П1–П48 (68 уроков) | 83.2KB |
| `core_p0…p8` | paid | 174 урока по фазам (бюджет §21.1 ≤150KB brotli — макс 62.6KB) | 12–62.6KB |
| `terms` | paid | глоссарий, 205 терминов | 24.2KB |
| `tests` | paid | 7 фазовых аттестаций (включая 144 ситуации Психологии) + 2 мат-теста | 21.5KB |
| `earning` | paid | 20 способов заработка | 10.4KB |

174 урока = LESSONS(76) + MATH(44) + PSY(48) + Вайбкодинг(4) + БОН(2) — сходится с фактом продукта.
Скрипт проверяет целостность (205 терминов, П1–П48, квизы у всех 174 уроков) и brotli-бюджет каждого пака — сборка падает при нарушении.
