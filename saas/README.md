...
|---|---|---|---|
| `core_demo` | всем | Фаза 0 (20 уроков) + Психология П1–П52 (72 урока) | 85.3KB |
| `core_p0…p8` | paid | 178 уроков по фазам (бюджет §21.1 ≤150KB brotli — макс 64.7KB) | 12–64.7KB |
| `terms` | paid | глоссарий, 205 терминов | 24.2KB |
| `tests` | paid | 7 фазовых аттестаций (включая 156 ситуаций Психологии) + 2 мат-теста | 21.5KB |
| `earning` | paid | 20 способов заработка | 10.4KB |

178 уроков = LESSONS(76) + MATH(44) + PSY(52) + Вайбкодинг(4) + БОН(2) — сходится с фактом продукта.
Скрипт проверяет целостность (205 терминов, П1–П52, квизы у всех 178 уроков) и brotli-бюджет каждого пака — сборка падает при нарушении.
