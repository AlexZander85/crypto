# tools/generate_all_40_widgets.py
import os
...
widget_js = """
/* =========================================================================
   V5-PSY-EXT: ИНТЕРАКТИВНЫЕ ТРЕНАЖЁРЫ П9–П40 (32 НОВЫХ ВИДЖЕТА)
   ========================================================================= */
...
// Helper for generating standard case widgets
...
makeStandardCaseWidget(40, 'widget_ps_l40_freedom_calc', '⏳', '«Калькулятор покупки свободы»', 'Выпускной финал Академии психологии.', 'Какова конечная цель создания торговой системы?', 'Автономия времени и освобождение жизни для семьи и здоровья', 'Круглосуточное рабство перед монитором', true, 'Поздравляем с выпуском из Академии психологии! 🎓', 'Система создается ради жизни, а не наоборот.');
"""

with open(OUT_JS, 'w', encoding='utf-8') as f:
    f.write(widget_js)

print("Regenerated all 32 widget functions in tools/psy_widgets_ext.js")
