# tools/generate_all_48_widgets.py
import os
...
widget_js = """
/* =========================================================================
   V5-PSY-EXT: ИНТЕРАКТИВНЫЕ ТРЕНАЖЁРЫ П9–П48 (40 НОВЫХ ВИДЖЕТОВ)
   ========================================================================= */
...
// П41–П48 (Новые продвинутые мастер-классы)
...
print("Generated all 40 widget functions in tools/psy_widgets_ext.js")
